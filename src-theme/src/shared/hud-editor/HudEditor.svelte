<script lang="ts">
    ...
    } from "./HudEditorContracts";
    import ComponentDrawer from "../../routes/clickgui/tabs/hud_editor/drawer/ComponentDrawer.svelte";
    import {darken} from "../../routes/clickgui/clickgui_store";
