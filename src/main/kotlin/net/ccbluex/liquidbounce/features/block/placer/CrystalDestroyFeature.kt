...
class CrystalDestroyFeature(eventListener: EventListener, private val module: EventListener) :
    ...
    private val rotationMode = modes(this, "RotationMode") {
        arrayOf(
            CrystalNormalRotationMode(it, module, Priority.IMPORTANT_FOR_USAGE_3),
            CrystalNoRotationMode(it, module),
        )
    }
    ...
    val repeatable = tickHandler {
        ...
        rotationMode.activeMode.rotate(rotation, isFinished = {
            ...
            runCrystalAttack(
                attack = { CrystalAttackSink.attack(target, swingMode) },
                resetDelay = chronometer::reset,
                clearTarget = { currentTarget = null },
            )
        })
    }
     ...
     */
    fun onDisable() {
        clearCrystalTarget { currentTarget = null }
    }
