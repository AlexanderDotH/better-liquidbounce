 ...
 */
package net.ccbluex.liquidbounce.features.clicking.pattern.patterns
...
object NormalDistributionPattern : ClickPattern {
    ...
    override fun fill(
        ...
        while (true) {
            val v = context.random.nextDouble()

            val band = frequencyBands.first { v >= it.top }

            t += context.random.nextGaussian(band.mean, band.std) * 20.0 / 1000.0
