...
internal fun <V : Value<*>> ParameterBuilder.Companion.value(
    paramName: String,
    typeName: String,
    all: Iterable<V>,
    predicate: (V) -> Boolean,
...
internal fun <V : Value<*>> ParameterBuilder.Companion.values(
    paramName: String,
    typeName: String,
    all: Iterable<V>,
    predicate: (V) -> Boolean,
) = values(paramName, typeName, { all }, predicate)

internal fun <V : Value<*>> ParameterBuilder.Companion.values(
    paramName: String,
    typeName: String,
    allProvider: () -> Iterable<V>,
    predicate: (V) -> Boolean,
...
fun ParameterBuilder.Companion.modules(
    name: String = "modules",
    allProvider: () -> Iterable<ClientModule>,
    predicate: (ClientModule) -> Boolean = { true },
) = values<ClientModule>(
    paramName = name,
    typeName = "Module",
...
internal fun <T : Any> ParameterBuilder.Companion.fromRegistry(
    paramName: String,
    typeName: String,
    registry: Registry<T>,
) = begin<T>(paramName)
