...
internal object SpearKillPrimedInstantPlanner {
    fun plan(request: SpearKillPrimedInstantPlanRequest): SpearKillPrimedInstantPlanResult {
        ...
        if (totalPacketBudget > accounting.maxPackets) {
        ...
        val sourcePredictedAccepted = movementExcess <=
            request.movementProfile.squaredDistanceThreshold * serverCountedPackets
        ...
        return SpearKillPrimedInstantPlanResult.Ready(
            SpearKillPrimedInstantPlan(
                ...
                dedicatedPrimingPackets = dedicatedPrimingPackets.toInt(),
                totalPreFinalPackets = totalPreFinalPackets.toInt(),
                finalPacketOrdinal = finalPacketOrdinal,
                serverCountedPackets = serverCountedPackets,
                totalOwnedPacketBudget = totalPacketBudget.toInt(),
