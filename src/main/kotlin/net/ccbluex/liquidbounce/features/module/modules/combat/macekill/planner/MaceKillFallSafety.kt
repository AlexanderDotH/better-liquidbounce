...
internal fun decideMaceKillFallSafetyFinish(
    lifecycle: MaceKillFallSafetyLifecycle,
...
internal fun preflightMaceKillFallSafety(
    ...
    if (hasInvalidMaceKillFallSafetyInput(initialFallDistance, safeFallDistance, steps)) {
...
private fun hasInvalidMaceKillFallSafetyInput(
    initialFallDistance: Double,
    safeFallDistance: Double,
    steps: List<MaceKillFallSafetyStep>,
): Boolean = !initialFallDistance.isFinite() || initialFallDistance < 0.0 ||
    !safeFallDistance.isFinite() || safeFallDistance < 0.0 || steps.any { !it.movement.isFinite() }
