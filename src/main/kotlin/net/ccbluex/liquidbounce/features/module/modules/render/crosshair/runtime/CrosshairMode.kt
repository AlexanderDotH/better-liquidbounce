...
package net.ccbluex.liquidbounce.features.module.modules.render.crosshair.runtime
...
abstract class CrosshairMode(name: String, final override val parent: ModeValueGroup<*>) : Mode(name) {
