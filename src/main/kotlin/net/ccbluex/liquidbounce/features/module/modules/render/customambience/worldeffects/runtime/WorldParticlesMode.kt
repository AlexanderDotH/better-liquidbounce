...
package net.ccbluex.liquidbounce.features.module.modules.render.customambience.worldeffects.runtime
...
internal abstract class WorldParticlesMode(
    name: String,
    protected val store: WorldParticleStore,
) : Mode(name) {
    ...
    private val renderHandler = handler<WorldRenderEvent> { event ->
        ...
        event.renderEnvironment {
            ...
            store.coords.forEach {
                val age = lifetime.last - store.coords.timeToDie(it) + event.partialTicks
