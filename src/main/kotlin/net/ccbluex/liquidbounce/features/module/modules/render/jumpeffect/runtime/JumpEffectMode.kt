...
abstract class JumpEffectMode internal constructor(
    name: String,
    final override val parent: ModeValueGroup<*>,
    private val runtime: JumpEffectRuntime,
) : Mode(name) {
    ...
    private val renderHandler = handler<WorldRenderEvent> { event ->
        event.renderEnvironment {
            runtime.circles.forEach {
                val age = lifetime.last - runtime.circles.timeToDie(it) + event.partialTicks
