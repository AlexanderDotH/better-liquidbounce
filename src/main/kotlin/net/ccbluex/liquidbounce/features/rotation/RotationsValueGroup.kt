...
import net.ccbluex.liquidbounce.features.rotation.processors.FailRotationProcessor
import net.ccbluex.liquidbounce.features.rotation.processors.ShortStopRotationProcessor
import net.ccbluex.liquidbounce.features.rotation.processors.anglesmooth.impl.AccelerationAngleSmooth
import net.ccbluex.liquidbounce.features.rotation.processors.anglesmooth.impl.AiAngleSmooth
import net.ccbluex.liquidbounce.features.rotation.processors.anglesmooth.impl.InterpolationAngleSmooth
import net.ccbluex.liquidbounce.features.rotation.processors.anglesmooth.impl.LinearAngleSmooth
import net.ccbluex.liquidbounce.features.rotation.processors.anglesmooth.impl.SigmoidAngleSmooth
...
) : ValueGroup("Rotations"), RotationTargetFactory {
