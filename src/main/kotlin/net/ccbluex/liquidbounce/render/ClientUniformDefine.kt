...
enum class ClientUniformDefine(val uboName: String, val size: Int) {
    ...
    FOG_VOLUME("FogVolumeData", std140Size { mat4f + mat4f + mat4f + repeat(7) { vec4 } }),
    FOG_BLUR("FogBlurData", std140Size { mat4f + mat4f + mat4f + repeat(10) { vec4 } }),
    UNIFIED_FOG("UnifiedFogData", std140Size { mat4f + mat4f + mat4f + repeat(8) { vec4 } }),
