...
/**
 * Player and storage geometry share one mask per effect. Combining the strongest active values keeps
 * both sources visible and makes the result independent of module evaluation order.
 */
