...
internal fun JsonObject.previewSetting(choice: String, setting: String) = getAsJsonObject(choice)
    .getAsJsonArray("value")
    .map { it.asJsonObject }
    .single { it["name"].asString == setting }["value"]

internal fun JsonObject.choiceValue(choice: String, value: String): JsonObject = getAsJsonObject(choice)
    .getAsJsonArray("value")
    .map { it.asJsonObject }
    .single { it["name"].asString == value }

internal fun JsonObject.settingValue(setting: String) = getAsJsonArray("value")
    .map { it.asJsonObject }
    .single { it["name"].asString == setting }["value"]
